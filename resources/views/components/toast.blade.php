...
@php
    $styles = [
        ...
        'error' => [
            ...
            'icon' => 'text-red-500',
            'iconPath' => 'M10 18a8 8 0 100-16 8 8 0 000 16zM8.28 7.22a.75.75 0 00-1.06 1.06L8.94 10l-1.72 1.72a.75.75 0 101.06 1.06L10 11.06l1.72-1.72a.75.75 0 00-1.06-1.06L10 8.94 8.28 7.22z',
        ],
    ];
...
<div
    ...
    role="alert"
    {{ $attributes->merge(['class' => 'fixed right-4 top-4 z-50 flex max-w-sm items-start gap-3 rounded-xl border p-4 shadow-lg ' . $s['bg']]) }}
>
