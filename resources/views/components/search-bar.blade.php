<form
    {{ $attributes->merge(['class' => 'flex flex-col gap-4 rounded-2xl border border-slate-200 bg-white p-2 shadow-lg sm:flex-row sm:items-center sm:gap-2', 'method' => 'GET', 'action' => '#']) }}
>
    <div class="flex-1">
